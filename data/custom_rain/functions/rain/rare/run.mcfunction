...
execute if score #weather CR matches 1 run function custom_rain:rain/rare/wither_skull
execute if score #weather CR matches 2 run function custom_rain:rain/rare/food
