...
execute if score #count CR matches 1 run scoreboard players operation #rng_max CR = #76 constant
execute if score #count CR matches 1 run function custom_rain:func/rng
execute if score #count CR matches 1 at @e[tag=CR_rain_point] run function custom_rain:rain/rare/random_mobs/0_75
