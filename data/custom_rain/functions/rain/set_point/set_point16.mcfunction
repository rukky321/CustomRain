#> custom_rain:rain/set_point/set_point16
#
# @within custom_rain:**

execute at @s run summon marker ~ ~ ~ {Tags:["CR_summon_multiplier"]}
execute at @s run summon marker ~ ~ ~ {Tags:["CR_summon_multiplier"]}
execute at @e[tag=CR_summon_multiplier] at @e[tag=CR_summon_multiplier] at @e[tag=CR_summon_multiplier] at @e[tag=CR_summon_multiplier] run summon marker ~ ~ ~ {Tags:["CR_rain_point","CR_target"]}
