...
execute if score #weather CR matches 2 run function custom_rain:rain/uncommon/trident
execute if score #weather CR matches 3 run function custom_rain:rain/uncommon/fire