...
execute at @s run summon area_effect_cloud ~ ~ ~ {Duration:2,Tags:["CR_rain_point","CR_target"]}
execute at @s run spreadplayers ~ ~ 1.0 24 false @e[tag=CR_target,limit=1]
execute at @e[tag=CR_target,limit=1] run summon area_effect_cloud ~ ~ ~ {Duration:2,Tags:["CR_surface_check"]}
